...
const fakeVCardQuoted = {
  ...
  message: {
    contactMessage: {
      displayName: "© Hamza-MD",
      vcard: `BEGIN:VCARD
VERSION:3.0
FN:© Hamza-MD
ORG:HamzaMD Official;
...
await sock.sendMessage(
  jid,
  {
    image: { url: "https://img.sanishtech.com/u/267297d35109d3530c31d600de5645e5.jpg" },
    caption,
    contextInfo: {
      mentionedJid: [jid],
      forwardingScore: 999,
